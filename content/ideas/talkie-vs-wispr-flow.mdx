...
Wispr Flow is the app I get compared to most on speed and polish, and it earns that — it's slick. I build Talkie, which makes almost the opposite set of bets, so instead of talking mine up I'll just lay both out. We both turn speech into text you can drop into any app; we disagree on privacy, price, and what happens to your words afterward.
