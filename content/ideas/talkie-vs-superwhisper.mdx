...
If you're reading this, you're probably already using Superwhisper — or weighing it — and wondering whether there's something that fits the way you work a little better. This is an honest look at where the two apps overlap, where they don't, and who each one is actually for.
