...
The Tier 1 set ships in the next build. We'll benchmark each one against a fixed test suite as we go — the test cases in each card above are the starting fixtures.
