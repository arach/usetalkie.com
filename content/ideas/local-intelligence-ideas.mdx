...
description: "We tested Apple's Foundation Models against 24 real Talkie use cases. Here is what works, what needs a prompt, and what runs without an external model fee."
date: "2026-04-04"
...
The routing principle we're landing on: **local by default, cloud as an intentional escalation**. Users who never connect an API key get a capable, private processing layer with no external model fee. Users who want deeper reasoning or larger context windows can opt into cloud providers without changing how the rest of the system works.
