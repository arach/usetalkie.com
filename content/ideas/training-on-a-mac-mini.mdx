...
Colab worked well for this. [5,044 training examples](https://huggingface.co/datasets/arach/training-lab), short sequences, small model. The free tier handled it. After 90 minutes I had 79.2% exact match on 510 of my 630 test cases.
