...
If you're reading this, you're probably already using DictaFlow — or you're weighing it — and you want to know whether Talkie does the same job differently. Both let you talk instead of type. Both run on a Mac. Past that, they aim at different users.
