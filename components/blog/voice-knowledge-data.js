...
export const obsidianNotes = {
  "open-scout": {
    ...
    content: [
      "# Open Scout",
      "",
      '> "Open Scout could be like this really pure play, agent-forward,',
      '> kind of synthesis of all the things I\'ve been building."',
      "",
      "## Why it exists",
      "Voice memos are crowded. This escapes those confines.",
      "",
      "## Open Questions",
      "- How much of Talkie's engine should be shared vs forked?",
      "- Is this a separate product or a Talkie power-user mode?",
      "",
      "## Connects to",
      "- [[Talkie Product]] — powers the voice features",
      "- [[Marketing]] — could be the breakout narrative",
      "- [[Workflow Builder]] — user-extensible processing",
    ].join("\n"),
  },
}
