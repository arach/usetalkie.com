...
const InfoBox = ({ type = 'info', children }) => {
  const styles = {
    ...
    success: 'bg-emerald-50 dark:bg-amber/10 border-emerald-200 dark:border-amber/30 text-emerald-800 dark:text-emerald-300',
  }
...
export default function TailscalePage() {
  return (
    ...
    >
      ...
      <div className="bg-canvas-alt rounded-xl border border-edge p-6 my-6 not-prose">
        <div className="flex flex-col md:flex-row items-center justify-center gap-8">
          <div className="flex flex-col items-center">
            <div className="w-16 h-16 rounded-xl bg-surface dark:bg-panel-bg-alt flex items-center justify-center mb-2">
              <Laptop className="w-8 h-8 text-ink-muted" />
            </div>
            <span className="text-sm font-medium text-ink">Your Mac</span>
            <span className="text-xs text-ink-faint font-mono">100.x.x.x</span>
          </div>

          <div className="flex flex-col items-center">
            <div className="w-24 h-px md:w-px md:h-24 bg-gradient-to-r md:bg-gradient-to-b from-blue-500 to-emerald-500"></div>
            <span className="text-[10px] font-mono text-ink-muted mt-1">WireGuard tunnel</span>
          </div>

          <div className="flex flex-col items-center">
            <div className="w-16 h-16 rounded-xl bg-surface dark:bg-panel-bg-alt flex items-center justify-center mb-2">
              <Smartphone className="w-8 h-8 text-ink-muted" />
            </div>
            <span className="text-sm font-medium text-ink">Your iPhone</span>
            <span className="text-xs text-ink-faint font-mono">100.x.x.x</span>
          </div>
        </div>
      </div>
      ...
      <div className="flex flex-col sm:flex-row gap-4 not-prose">
        ...
        >
          <ArrowLeft className="w-5 h-5 text-ink-muted group-hover:text-amber group-hover:-translate-x-1 transition-all" />
          <div>
