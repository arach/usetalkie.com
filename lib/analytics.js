 ...
 * @param {string} source - Where the click originated: 'go_page', 'website', 'email', etc.
 * @param {string} campaign - UTM campaign if present
 */
export function trackAppStoreClick(source = 'unknown', campaign = null) {
