...
const MAC_GALLERY = [
  ...
  { src: '/screenshots/mac-recording.png', title: 'Dictation Capture', caption: 'Set the hotkey, microphone, and local capture path Talkie actually uses.', narration: 'The dictation setup is visible before you speak: keyboard trigger, push-to-talk behavior, microphone, and the sounds that confirm capture started.', audio: '/audio/tour/mac-recording.mp3' },
