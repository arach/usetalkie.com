...
const MAC_GALLERY = [
  ...
  { src: '/screenshots/mac-recording.png', title: 'Recording', caption: 'Hold the hotkey and Talkie captures your voice without taking over the screen.', narration: 'Start anywhere on your Mac. The recording HUD stays focused on one job: capture what you are saying, then get out of the way.', audio: '/audio/tour/mac-recording.mp3' },
  { slug: 'mac-island', src: '/screenshots/mac-island.png', title: 'Island', caption: 'Fresh captures surface as a small draggable island at the top of the display.', narration: 'When Talkie saves a capture, the island gives you a lightweight handoff surface. Drag it into another app, mark it up, or let it disappear.' },
  { slug: 'mac-transcription-settings', src: '/screenshots/mac-transcription-settings.png', title: 'Transcription Settings', caption: 'Choose the local speech model that turns recordings into text.', narration: 'The transcription settings make the speech engine explicit. Talkie can keep recognition local, with the active model visible before you record.' },
  { slug: 'mac-dictionary', src: '/screenshots/mac-dictionary.png', title: 'Dictionary', caption: 'Teach Talkie the names, terms, and replacements you actually say.', narration: 'Dictionary rules help Talkie understand your words the way you use them: names, product terms, acronyms, and spoken replacements.' },
...
const WATCH_GALLERY = [
  { slug: 'watch-link', src: '/screenshots/apple-watch-link.png', title: 'Ready', caption: 'Raise your wrist, tap record, and keep moving.', narration: 'The Watch app is for the moment before the thought disappears. One tap starts capture, then the recording syncs back through your phone to the same Talkie library.' },
  { slug: 'watch-record', src: '/screenshots/apple-watch-ready.png', title: 'Record', caption: 'A big tap target for quick wrist capture.', narration: 'The Watch screen keeps the interaction deliberately oversized: start, stop, and ask AI are all reachable without turning a passing idea into another task.' },
  { slug: 'watch-launch', src: '/screenshots/apple-watch-launch.png', title: 'Launch', caption: 'The wrist-sized Talkie surface, trimmed to essentials.', narration: 'Talkie on Watch keeps the brand signal and the recording path visible at a glance. It is not a second inbox; it is the fastest doorway back into the system.' },
]
